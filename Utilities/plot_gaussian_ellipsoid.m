function h = plot_gaussian_ellipsoid(m, C, sdwidth, color,npts, axh)
...
switch numel(m)
   ...
   case 3, h=show3d(m(:),C,sdwidth,npts,axh,color);
   otherwise
...
%-----------------------------
function h = show3d(means, C, sdwidth, npts, axh,color)
...
h = mesh(axh, xp,yp,zp,'FaceAlpha','0.1','EdgeColor',color);
